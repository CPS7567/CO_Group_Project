import sys
# input_file = "E:\\CO\\bonus\\SimpleAssembler\\input.txt"
# output_file = "E:\\CO\\bonus\\SimpleAssembler\\output.txt"
...
def mul(a, l ,index):
    l = l.split(',')
    b,c,d = l[0],l[1],l[2]
    k = {'funct7' : '0000000' , 'funct3' : '000' , 'opcode' : '1110111'}
    if b in abi_to_register or b in registers:
            b = abi_to_register[b] if b in abi_to_register else b
            b = int(b[1:])
            b ,i = regis_to_bin(b) 
...
def rst():
    t = "00000000000000000001000001110111"
    return t 

def halt():
    t = "00000000000000000010000001110111"
    return t
...
def rvrs(a,l , index):
    ...
    b = l[0]   #rdddd
    c = l[1] #rs11111
    k = {'funct7' : '0000000' , 'funct3' : '011' , 'opcode' : '1110111'}
    if b in abi_to_register or b in registers:
            b = abi_to_register[b] if b in abi_to_register else b
            b = int(b[1:])
            b ,i = regis_to_bin(b) 
    ...
    t = f"{k['funct7']}00000{c}{k['funct3']}{b}{k['opcode']}"
    return t
...
for i in lines:
    if i[0] in r_dict:
        ...
        st = mul(i[0] , i[1] , lines.index(i))
    elif i[0] == 'rst':
        st = rst()
    elif i[0] == 'rvrs':
        st = rvrs(i[0],i[1] , lines.index(i))
        pass
    elif i[0] == "halt":
        st = halt()
    else:
